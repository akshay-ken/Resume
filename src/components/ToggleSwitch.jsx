  ...
  return (
    <label className="inline-flex self-center ml-auto items-center relative">
      ...
      <svg
        ...
        className=" fill-orange-500 peer-checked:opacity-70 absolute w-5 md:w-6 md:h-6 h-5 left-[5px] md:left-[13px]"
      >
      ...
      <svg
        ...
        id="Layer_1"
        xmlns="http://www.w3.org/2000/svg"
        className="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute md:w-6 w-5 h-5 md:h-6 right-[8px] md:right-[13px]"
      >
